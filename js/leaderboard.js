...
export function Leaderboard() {
  ...
  >
    <div
      style="display: grid; row-gap: 7px; ${isMobile
        ? "grid-template-columns: auto;"
        : "grid-template-columns: 80px auto repeat(3, 150px);"} width: 100%;"
    >
      ${!isMobile
        ? html` <div class="header-cell" style="grid-area: 1 / 1 / 2 / 2;">
              Rank
            </div>
            <div class="header-cell" style="grid-area: 1 / 2 / 2 / 3;">
              Name
            </div>
